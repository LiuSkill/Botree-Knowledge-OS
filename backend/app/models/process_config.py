...
class ProcessProduct(TimestampMixin, OperatorMixin, SoftDeleteMixin, Base):
    ...
    description: Mapped[str | None] = mapped_column(Text, nullable=True, comment="描述信息")
    unit: Mapped[str] = mapped_column(String(50), nullable=False, comment="单位")
    output_type: Mapped[str] = mapped_column(String(30), default="product", nullable=False, comment="产出物类型：product/byproduct/solid_waste/wastewater/waste_gas")
    target_output_category: Mapped[str | None] = mapped_column(String(30), nullable=True, comment="产品需求分类：li/ni/co/mn/cu/graphite")
    is_product_form: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False, comment="是否达到产品形态")
...
class ProcessCalculationOutput(TimestampMixin, OperatorMixin, SoftDeleteMixin, Base):
    ...
    output_type: Mapped[str] = mapped_column(String(30), nullable=False, comment="产出类型：product/byproduct/solid_waste/wastewater/waste_gas")
...
class ProcessRouteNode(TimestampMixin, SoftDeleteMixin, Base):
    ...
    node_id: Mapped[int] = mapped_column(ForeignKey("process_nodes.id"), nullable=False, comment="工艺节点ID")
    sort_order: Mapped[int] = mapped_column(Integer, default=0, nullable=False, comment="排序值")
    option_group_code: Mapped[str | None] = mapped_column(String(100), nullable=True, comment="互斥工艺选项组编码")
    option_code: Mapped[str | None] = mapped_column(String(100), nullable=True, comment="已选工艺选项编码")
