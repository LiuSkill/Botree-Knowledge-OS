...
('dashboard', 'access', 'dashboard', '菜单访问：首页', NOW(), NOW()),
('knowledge', 'access', 'knowledge', '菜单访问：知识中心', NOW(), NOW()),
('project', 'access', 'project', '菜单访问：项目中心', NOW(), NOW()),
('authorization', 'access', 'authorization', '菜单访问：知识授权中心', NOW(), NOW()),
('review', 'access', 'review', '菜单访问：审核中心', NOW(), NOW()),
...
('system', 'qa-audit', 'system:qa-audit', '菜单访问：问答审计', NOW(), NOW()),
('dashboard', 'view', 'dashboard:view', '首页：查看首页统计', NOW(), NOW()),
('knowledge', 'view', 'knowledge:view', '知识中心：查看知识资料', NOW(), NOW()),
...
('project', 'view', 'project:view', '项目中心：查看项目/项目资料', NOW(), NOW()),
('project', 'create', 'project:create', '项目中心：新增项目', NOW(), NOW()),
('project', 'edit', 'project:edit', '项目中心：编辑项目', NOW(), NOW()),
('project', 'delete', 'project:delete', '项目中心：删除项目', NOW(), NOW()),
('project', 'chat', 'project:chat', '项目中心：项目问答跳转', NOW(), NOW()),
('project:directory', 'create', 'project:directory:create', '项目资料目录：新增项目资料目录', NOW(), NOW()),
('project:directory', 'edit', 'project:directory:edit', '项目资料目录：编辑项目资料目录', NOW(), NOW()),
('project:directory', 'delete', 'project:directory:delete', '项目资料目录：删除项目资料目录', NOW(), NOW()),
('project', 'upload', 'project:upload', '项目资料：上传项目资料', NOW(), NOW()),
('project', 'submit-review', 'project:submit-review', '项目资料：提交/发布项目资料', NOW(), NOW()),
('project:document', 'edit', 'project:document:edit', '项目资料：编辑项目资料元数据', NOW(), NOW()),
('project:document', 'delete', 'project:document:delete', '项目资料：删除项目资料', NOW(), NOW()),
('project:document', 'preview', 'project:document:preview', '项目资料：预览项目资料', NOW(), NOW()),
('project:document', 'download', 'project:document:download', '项目资料：下载项目资料', NOW(), NOW()),
('project:document', 'retry-parse', 'project:document:retry-parse', '项目资料：重试项目资料解析', NOW(), NOW()),
('project:document', 'retry-index', 'project:document:retry-index', '项目资料：重试项目资料索引', NOW(), NOW()),
('project:document', 'security-update', 'project:document:security-update', '项目资料：保存项目资料密级', NOW(), NOW()),
('project:document', 'version-view', 'project:document:version-view', '项目资料：查看项目资料版本', NOW(), NOW()),
('project:document', 'version-create', 'project:document:version-create', '项目资料：上传项目资料新版本', NOW(), NOW()),
('project:document', 'version-set-current', 'project:document:version-set-current', '项目资料：设置项目资料当前版本', NOW(), NOW()),
('authorization', 'view', 'authorization:view', '知识授权中心：查看授权', NOW(), NOW()),
('review', 'view', 'review:view', '审核中心：查看审核记录', NOW(), NOW()),
('review', 'approve', 'review:approve', '审核中心：审核通过', NOW(), NOW()),
('review', 'reject', 'review:reject', '审核中心：审核驳回', NOW(), NOW()),
('review', 'build-index', 'review:build-index', '审核中心：解析并构建索引', NOW(), NOW()),
('ai:project-chat', 'view', 'ai:project-chat:view', '项目问答：进入项目问答页面', NOW(), NOW()),
('ai:project-chat', 'create-session', 'ai:project-chat:create-session', '项目问答：新建项目问答会话', NOW(), NOW()),
('ai:project-chat', 'send-message', 'ai:project-chat:send-message', '项目问答：发送项目问答消息', NOW(), NOW()),
('ai:project-chat', 'manage-session', 'ai:project-chat:manage-session', '项目问答：重命名/置顶/收藏项目问答会话', NOW(), NOW()),
('ai:project-chat', 'delete-session', 'ai:project-chat:delete-session', '项目问答：删除项目问答会话', NOW(), NOW()),
('ai:project-chat', 'feedback', 'ai:project-chat:feedback', '项目问答：反馈项目问答答案', NOW(), NOW()),
('ai:base-chat', 'view', 'ai:base-chat:view', '基础问答：进入基础问答页面', NOW(), NOW()),
('ai:base-chat', 'create-session', 'ai:base-chat:create-session', '基础问答：新建基础问答会话', NOW(), NOW()),
('ai:base-chat', 'send-message', 'ai:base-chat:send-message', '基础问答：发送基础问答消息', NOW(), NOW()),
('ai:base-chat', 'manage-session', 'ai:base-chat:manage-session', '基础问答：重命名/置顶/收藏基础问答会话', NOW(), NOW()),
('ai:base-chat', 'delete-session', 'ai:base-chat:delete-session', '基础问答：删除基础问答会话', NOW(), NOW()),
('ai:base-chat', 'feedback', 'ai:base-chat:feedback', '基础问答：反馈基础问答答案', NOW(), NOW()),
('system:user', 'view', 'system:user:view', '用户管理：查看用户列表', NOW(), NOW()),
('system:user', 'create', 'system:user:create', '用户管理：新增用户账号', NOW(), NOW()),
('system:user', 'edit', 'system:user:edit', '用户管理：编辑用户资料', NOW(), NOW()),
...
('system:permission', 'delete-role', 'system:permission:delete-role', '权限矩阵：删除角色', NOW(), NOW()),
('system:permission', 'save', 'system:permission:save', '权限矩阵：保存角色权限', NOW(), NOW()),
('system:model', 'view', 'system:model:view', '模型配置：查看模型配置', NOW(), NOW()),
('system:model', 'create', 'system:model:create', '模型配置：新增模型配置', NOW(), NOW()),
('system:model', 'edit', 'system:model:edit', '模型配置：编辑/启停模型配置', NOW(), NOW()),
('system:model', 'test', 'system:model:test', '模型配置：测试模型连接', NOW(), NOW()),
('system:model', 'set-default', 'system:model:set-default', '模型配置：设置默认模型', NOW(), NOW()),
('system:model', 'delete', 'system:model:delete', '模型配置：删除模型配置', NOW(), NOW()),
('system:log', 'view', 'system:log:view', '操作日志：查看操作日志', NOW(), NOW()),
('system:qa-audit', 'view', 'system:qa-audit:view', '问答审计：查看问答审计', NOW(), NOW())
