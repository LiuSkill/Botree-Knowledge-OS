...
CREATE TABLE IF NOT EXISTS model_configs (
	...
	model_type VARCHAR(30) NOT NULL COMMENT '模型类型：llm/embedding/reranker/intent/evidence_judge/graph_extractor', 
...
CREATE TABLE IF NOT EXISTS chat_messages (
	...
	agent_trace_json TEXT COMMENT 'Agent执行过程JSON', 
	created_at DATETIME NOT NULL COMMENT '创建时间', 
	updated_at DATETIME NOT NULL COMMENT '更新时间', 
	PRIMARY KEY (id), 
...
CREATE TABLE IF NOT EXISTS retrieval_traces (
	...
	sub_queries_json TEXT COMMENT 'Qwen拆解后的子查询JSON',
	retriever_hits_json TEXT COMMENT '各路召回命中统计JSON',
	rerank_result_json TEXT COMMENT 'Reranker重排结果JSON',
	citations_json TEXT COMMENT '最终引用JSON，包含project_id/document_id/drawing_no/page_no/chunk_id',
	trace_json TEXT COMMENT '完整检索编排Trace JSON',
