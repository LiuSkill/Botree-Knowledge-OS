...
export const MENU_PERMISSIONS = {
  ...
  REVIEW: 'review',
  PROCESS_CONFIG_MATERIAL: 'process_config:material',
...
export const ACTION_PERMISSIONS = {
  ...
  PROCESS_CONFIG_MATERIAL_VIEW: 'process_config:material:view',
  PROCESS_CONFIG_MATERIAL_CREATE: 'process_config:material:create',
  PROCESS_CONFIG_MATERIAL_UPDATE: 'process_config:material:update',
  PROCESS_CONFIG_MATERIAL_DELETE: 'process_config:material:delete',
  PROCESS_CONFIG_MATERIAL_IMPORT: 'process_config:material:import',
  PROCESS_CONFIG_MATERIAL_EXPORT: 'process_config:material:export',

  PROCESS_CONFIG_PRODUCT_VIEW: 'process_config:product:view',
  PROCESS_CONFIG_PRODUCT_CREATE: 'process_config:product:create',
  PROCESS_CONFIG_PRODUCT_UPDATE: 'process_config:product:update',
  PROCESS_CONFIG_PRODUCT_DELETE: 'process_config:product:delete',
  PROCESS_CONFIG_PRODUCT_IMPORT: 'process_config:product:import',
  PROCESS_CONFIG_PRODUCT_EXPORT: 'process_config:product:export',

  PROCESS_CONFIG_CONSUMABLE_VIEW: 'process_config:consumable:view',
  PROCESS_CONFIG_CONSUMABLE_CREATE: 'process_config:consumable:create',
  PROCESS_CONFIG_CONSUMABLE_UPDATE: 'process_config:consumable:update',
  PROCESS_CONFIG_CONSUMABLE_DELETE: 'process_config:consumable:delete',
  PROCESS_CONFIG_CONSUMABLE_IMPORT: 'process_config:consumable:import',
  PROCESS_CONFIG_CONSUMABLE_EXPORT: 'process_config:consumable:export',

  PROCESS_CONFIG_PUBLIC_SERVICE_VIEW: 'process_config:public_service:view',
  PROCESS_CONFIG_PUBLIC_SERVICE_CREATE: 'process_config:public_service:create',
  PROCESS_CONFIG_PUBLIC_SERVICE_UPDATE: 'process_config:public_service:update',
  ...
  PROCESS_CONFIG_NODE_UPDATE: 'process_config:node:update',
  PROCESS_CONFIG_NODE_DELETE: 'process_config:node:delete',
  PROCESS_CONFIG_NODE_IMPORT: 'process_config:node:import',
  PROCESS_CONFIG_NODE_EXPORT: 'process_config:node:export',

  PROCESS_CONFIG_ROUTE_VIEW: 'process_config:route:view',
  PROCESS_CONFIG_ROUTE_CREATE: 'process_config:route:create',
  PROCESS_CONFIG_ROUTE_UPDATE: 'process_config:route:update',
...
export const MENU_PERMISSION_TREE: MenuDefinition[] = [
  ...
  { id: MENU_PERMISSIONS.REVIEW, name: '审核中心', path: '/reviews', children: [] },
  {
    ...
    path: '/process-config',
    children: [
      { id: MENU_PERMISSIONS.PROCESS_CONFIG_MATERIAL, name: '原料库', path: '/process-config/materials', children: [] },
      { id: MENU_PERMISSIONS.PROCESS_CONFIG_PRODUCT, name: '产品库', path: '/process-config/products', children: [] },
      { id: MENU_PERMISSIONS.PROCESS_CONFIG_CONSUMABLE, name: '消耗品库', path: '/process-config/consumables', children: [] },
...
export const ACTION_PERMISSION_GROUPS: ActionGroupDefinition[] = [
  ...
  {
    module: 'process-config-material',
    module_name: '原料库',
    menu_ids: [MENU_PERMISSIONS.PROCESS_CONFIG_MATERIAL],
    actions: [
      { action: 'view', name: '查看原料', code: ACTION_PERMISSIONS.PROCESS_CONFIG_MATERIAL_VIEW },
      { action: 'create', name: '新增原料', code: ACTION_PERMISSIONS.PROCESS_CONFIG_MATERIAL_CREATE },
      { action: 'update', name: '编辑原料', code: ACTION_PERMISSIONS.PROCESS_CONFIG_MATERIAL_UPDATE },
      { action: 'delete', name: '删除原料', code: ACTION_PERMISSIONS.PROCESS_CONFIG_MATERIAL_DELETE },
      { action: 'import', name: '导入原料', code: ACTION_PERMISSIONS.PROCESS_CONFIG_MATERIAL_IMPORT },
      { action: 'export', name: '导出原料', code: ACTION_PERMISSIONS.PROCESS_CONFIG_MATERIAL_EXPORT },
    ],
  },
  {
    module: 'process-config-product',
    module_name: '产品库',
    menu_ids: [MENU_PERMISSIONS.PROCESS_CONFIG_PRODUCT],
    actions: [
      { action: 'view', name: '查看产品', code: ACTION_PERMISSIONS.PROCESS_CONFIG_PRODUCT_VIEW },
      { action: 'create', name: '新增产品', code: ACTION_PERMISSIONS.PROCESS_CONFIG_PRODUCT_CREATE },
      { action: 'update', name: '编辑产品', code: ACTION_PERMISSIONS.PROCESS_CONFIG_PRODUCT_UPDATE },
      { action: 'delete', name: '删除产品', code: ACTION_PERMISSIONS.PROCESS_CONFIG_PRODUCT_DELETE },
      { action: 'import', name: '导入产品', code: ACTION_PERMISSIONS.PROCESS_CONFIG_PRODUCT_IMPORT },
      { action: 'export', name: '导出产品', code: ACTION_PERMISSIONS.PROCESS_CONFIG_PRODUCT_EXPORT },
    ],
  },
  {
    module: 'process-config-consumable',
    module_name: '消耗品库',
    menu_ids: [MENU_PERMISSIONS.PROCESS_CONFIG_CONSUMABLE],
    actions: [
      { action: 'view', name: '查看消耗品', code: ACTION_PERMISSIONS.PROCESS_CONFIG_CONSUMABLE_VIEW },
      { action: 'create', name: '新增消耗品', code: ACTION_PERMISSIONS.PROCESS_CONFIG_CONSUMABLE_CREATE },
      { action: 'update', name: '编辑消耗品', code: ACTION_PERMISSIONS.PROCESS_CONFIG_CONSUMABLE_UPDATE },
      { action: 'delete', name: '删除消耗品', code: ACTION_PERMISSIONS.PROCESS_CONFIG_CONSUMABLE_DELETE },
      { action: 'import', name: '导入消耗品', code: ACTION_PERMISSIONS.PROCESS_CONFIG_CONSUMABLE_IMPORT },
      { action: 'export', name: '导出消耗品', code: ACTION_PERMISSIONS.PROCESS_CONFIG_CONSUMABLE_EXPORT },
    ],
  },
  {
    module: 'process-config-public-service',
    module_name: '公共服务库',
    menu_ids: [MENU_PERMISSIONS.PROCESS_CONFIG_PUBLIC_SERVICE],
    actions: [
      { action: 'view', name: '查看公共服务', code: ACTION_PERMISSIONS.PROCESS_CONFIG_PUBLIC_SERVICE_VIEW },
      { action: 'create', name: '新增公共服务', code: ACTION_PERMISSIONS.PROCESS_CONFIG_PUBLIC_SERVICE_CREATE },
      { action: 'update', name: '编辑公共服务', code: ACTION_PERMISSIONS.PROCESS_CONFIG_PUBLIC_SERVICE_UPDATE },
      { action: 'delete', name: '删除公共服务', code: ACTION_PERMISSIONS.PROCESS_CONFIG_PUBLIC_SERVICE_DELETE },
      { action: 'import', name: '导入公共服务', code: ACTION_PERMISSIONS.PROCESS_CONFIG_PUBLIC_SERVICE_IMPORT },
      { action: 'export', name: '导出公共服务', code: ACTION_PERMISSIONS.PROCESS_CONFIG_PUBLIC_SERVICE_EXPORT },
    ],
  },
  {
    module: 'process-config-node',
    module_name: '工艺节点库',
    menu_ids: [MENU_PERMISSIONS.PROCESS_CONFIG_NODE],
    actions: [
      { action: 'view', name: '查看工艺节点', code: ACTION_PERMISSIONS.PROCESS_CONFIG_NODE_VIEW },
      { action: 'create', name: '新增工艺节点', code: ACTION_PERMISSIONS.PROCESS_CONFIG_NODE_CREATE },
      { action: 'update', name: '编辑工艺节点', code: ACTION_PERMISSIONS.PROCESS_CONFIG_NODE_UPDATE },
      { action: 'delete', name: '删除工艺节点', code: ACTION_PERMISSIONS.PROCESS_CONFIG_NODE_DELETE },
      { action: 'import', name: '导入工艺节点', code: ACTION_PERMISSIONS.PROCESS_CONFIG_NODE_IMPORT },
      { action: 'export', name: '导出工艺节点', code: ACTION_PERMISSIONS.PROCESS_CONFIG_NODE_EXPORT },
    ],
  },
  {
    module: 'process-config-route',
    module_name: '工艺路线库',
    menu_ids: [MENU_PERMISSIONS.PROCESS_CONFIG_ROUTE],
    actions: [
      { action: 'view', name: '查看工艺路线', code: ACTION_PERMISSIONS.PROCESS_CONFIG_ROUTE_VIEW },
      { action: 'create', name: '新增工艺路线', code: ACTION_PERMISSIONS.PROCESS_CONFIG_ROUTE_CREATE },
      { action: 'update', name: '编辑工艺路线', code: ACTION_PERMISSIONS.PROCESS_CONFIG_ROUTE_UPDATE },
