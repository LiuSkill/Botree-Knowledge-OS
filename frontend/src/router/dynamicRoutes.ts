...
const pageComponents: Record<string, RouteComponent> = {
  ...
  '/process-config/labor-costs': () => import('@/views/process-config/LaborCostLibraryPage.vue'),
  '/process-config/equipment-assets': () => import('@/views/process-config/EquipmentAssetLibraryPage.vue'),
  '/process-config/infrastructure-assets': () => import('@/views/process-config/InfrastructureAssetLibraryPage.vue'),
