...
const iconByMenuId: Record<string, Component> = {
  ...
  'process_config:product': ServerIcon,
  'process_config:consumable': FileSearchIcon,
  'process_config:public_service': BookOpenIcon,
  'process_config:labor': UserIcon,
  'process_config:asset_equipment': ServerIcon,
  'process_config:asset_infrastructure': TableIcon,
