...
const MENU_KEY_BY_ID: Record<string, string> = {
  ...
  'process_config:labor': 'menu.laborCost', 'process_config:equipment_asset': 'menu.equipmentAsset',
  'process_config:infrastructure_asset': 'menu.infrastructureAsset', 'process_config:asset_equipment': 'menu.equipmentAsset',
  'process_config:asset_infrastructure': 'menu.infrastructureAsset',
